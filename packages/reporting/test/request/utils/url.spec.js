...
const queryStrings = [
  ...
  },
  {
    ...
    url_parts: {
      ...
      query:
        'D=DM_LOC%3Dhttp%253A%252F%252Fwww.eltern.de%252F%253Fbpid%253Dgrunerjahr%2526_rsiL%253D0%26DM_EOM%3D1&C=F09828&asidi=cliqz.com/tracking&asidi=V6roVyy38IZUh0ZkC_jXhw',
      searchParams: [
        [
          'D',
...
describe('utils/url', function () {
  describe('#isPrivateIP', function () {
    ...
    it('should detect public ipv6 address', function () {
      chai.expect(isPrivateIP('2001:0db8:85a3:0000:0000:8a2e:0370:7334')).to.be
        .false;
    });
  });
        ...
        spec.forEach(function (testcase) {
          ...
          it(urlDesc, function () {
            ...
            if (expected.searchParams) {
              chai
                .expect(actual.searchParams.params.length, 'detected QS values')
