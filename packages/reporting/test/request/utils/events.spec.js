...
import { EventEmitter } from '../../../src/request/utils/events';
...
describe('core/events', function () {
  ...
  beforeEach(function () {
    CliqzEvents = new EventEmitter();
  });

  context('CliqzEvents tests', function () {
    beforeEach(function () {
      handlerCalled = 0;
      CliqzEvents.subscribe(eventID, dummyEventHandler);
    });

    describe('Test event subscribe', function () {
      it('Handler is in event list', function () {
        expect(CliqzEvents.listeners.get(eventID).length).to.be.above(0);
      });
    });
    ...
    describe('Two functions subscribed', function () {
      ...
      beforeEach(function () {
        fn1Called = 0;
        fn2Called = 0;
        CliqzEvents.subscribe(eventID, fn1);
        fn2Subscription = CliqzEvents.subscribe(eventID, fn2);
      });
